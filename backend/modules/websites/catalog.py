...
CATEGORIES: List[Dict[str, Any]] = [
    ...
    {"id": "gym",        "name": "صالات رياضية",       "icon": "🏋️", "color": "#0891B2",
     "image": "https://images.unsplash.com/photo-1534258936925-c58bed479fcb?w=600&q=70"},
    {"id": "academy",    "name": "أكاديميات تعليمية",   "icon": "🎓", "color": "#7C2D12",
